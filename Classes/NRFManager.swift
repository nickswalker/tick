...
public class NRFManager:NSObject, CBCentralManagerDelegate, UARTPeripheralDelegate, TrickleQueueDelegate {
    ...
    public init(delegate:NRFManagerDelegate? = nil,
        onConnect connectionCallback:(()->())? = nil,
        onDisconnect disconnectionCallback:(()->())? = nil,
        onData dataCallback:((data:NSData?, string:String?)->())? = nil,
...
let SERIAL_SERVICE_UUID = "D3E60000-8F36-40D6-B2D5-C5D9F5E81869"
let SERIAL_RX_UUID = "D3E60004-8F36-40D6-B2D5-C5D9F5E81869"
let SERIAL_TX_UUID = "D3E60005-8F36-40D6-B2D5-C5D9F5E81869"

// MARK: Class Methods
extension UARTPeripheral {
    class func uartServiceUUID() -> CBUUID {
        return CBUUID(string:SERIAL_SERVICE_UUID)
    }
    
    class func txCharacteristicsUUID() -> CBUUID {
        return CBUUID(string:SERIAL_TX_UUID)
    }
    
    class func rxCharacteristicsUUID() -> CBUUID {
        return CBUUID(string:SERIAL_RX_UUID)
    }
